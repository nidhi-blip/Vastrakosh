import main from '../../assets/sale/main.png'
import star from '../../assets/sale/star.png'
import tank from '../../assets/product/tank.png'
import button from '../../assets/Home/button.png'
export function Sale(){
    return(<>
     <div className="container-fluid ">
        <div className="row sale-banner">
            <div className="d-flex justify-content-end">
                <img className="w-40px" src={star}/>
            </div>


            <div className="overlay text-bold">
                <h1>SHOP,SAVE,SLAY</h1>
                <h1>SITEWIDE SALE</h1>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="row  ">
                        <div className="col-lg-4">
                            <div className="card">
                                <img src={tank} className="card-img-top" alt="Clothing Item 1"/>
